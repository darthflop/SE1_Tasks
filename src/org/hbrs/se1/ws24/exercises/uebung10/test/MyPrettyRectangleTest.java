...
import org.hbrs.se1.ws24.exercises.uebung10.BoundingBoxFactory;
...
public class MyPrettyRectangleTest {
    ...
    public void testSameIdentity() {
        ...
        assertTrue(left.equals(new MyPrettyRectangle(0.0, 1.0, 3.0, 3.0)));
    ...
    public void testGetBoundingBox( ) {
        ...
        assertEquals(expected, boundingBox);

        // Testen sie zudem, ob ueberhaupt ein Objekt zurueckgegeben wird,
        // d.h. der Rueckgabe-Wert ungleich NULL ist
        //
        // [ihr Code]
        assertNotNull(boundingBox, "Die Methode sollte ein gültiges Rechteck zurückgeben.");
        ...
        assertNotNull(emptyBoundingBox, "Ein Null-Rechteck sollte erzeugt werden, wenn das Array leer ist.");
        assertEquals(new MyPrettyRectangle(0.0, 0.0, 0.0, 0.0), emptyBoundingBox,
                "Ein leeres Array sollte ein Rechteck mit vier mal 0 zurückgeben.");

        // Test, ob die Übergabe eines NULL-Werts erfolgreich abgefangen wurde (Rueckgabe == NULL!)
        //
        // [ihr Code]
        MyPrettyRectangle nullBoundingBox = BoundingBoxFactory.getBoundingBox(null);
        assertNull(nullBoundingBox, "Ein NULL-Array sollte zu einem NULL-Wert führen.");
